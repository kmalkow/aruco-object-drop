...
path = 'C:/Users/nicol/OneDrive/Bureaublad/IMAV2024/ImageCalibration/*.jpg'   
...
for file in images:
  ...
  if ret == True:
    ...
    # Saving the image
    cv2.imwrite('C:/Users/nicol/OneDrive/Bureaublad/IMAV2024/ImageCalibration/ChessBoard_Detected_{}.JPG'.format(counter), img)
    # --------------------------------------------------------
...
pathStore = 'C:/Users/nicol/OneDrive/Bureaublad/IMAV2024/CameraCalibration_Variables/cameraCalibration.xml'   
