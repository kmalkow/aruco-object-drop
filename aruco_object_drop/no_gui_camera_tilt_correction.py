...
def main():
    ...
    if not cap.isOpened():
        raise ValueError(f"Failed to open camera on port {usb_number}. Please check the port number and try again.")
    
    # Set the resolution you want
    desired_width = 1920  # Example: 1920 pixels wide
    desired_height = 1440  # Example: 1080 pixels tall
